...
- **Authentication:** The backend must first resolve the tenant (via slug), connect to that specific tenant DB, and _then_ query `core.users`.

---

## 🗺️ Foreign Key Complexity

The remote database (172.25.0.25) reveals a complex web of dependencies where foreign keys reference _different_ versions of the truth:
