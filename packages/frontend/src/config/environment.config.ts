...
export const getConfigValue = (key: string, defaultValue?: string): string => {
  ...
  const defaults: Record<string, string> = {
    ...
    API_URL: 'https://ristix.bdo-ki.com/api/v1',
...
export const getEnvironmentConfig = (): EnvironmentConfig => {
  return {
    ...
    api: {
      baseUrl: getConfigValue('API_URL', 'https://ristix.bdo-ki.com/api/v1'),
...
export const getApiBaseUrl = (): string => getConfigValue('API_URL', 'http://ristix.bdo-ki.com/api/v1');
