...
export const PERMISSION_OVERRIDES: Record<string, string | string[]> = {
    ...
    'collective-impairment': ['banking.collective.bucket.view'],
    ...
    'ifrs9': 'banking.reports.ifrs9.nominative.view',
    ...
    'individual-impairment': 'banking.individual.view',
...
export const NAME_TO_LEGACY_ID_MAP: Record<string, string> = {
    ...
    'Individual Impairment': 'individual-impairment',
