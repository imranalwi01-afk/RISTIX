// packages/frontend/src/app/(consultant)/projects/page.tsx
// ============================================================================
// IFRS9 FRONTEND - PROJECT MANAGEMENT PAGE
// ============================================================================
// Purpose: Consultant project management and client engagement tracking
    ...
    <Container maxWidth="xl">
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="subtitle1" color="text.secondary">
          Consultant project management and client engagement tracking
        </Typography>
      </Box>
          ...
          <Card>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" paragraph>
                This page provides consultant project management and client engagement tracking. The interface will be enhanced with
              ...
              <Alert severity="info" sx={{ mt: 2 }}>
                <Typography variant="body2">
                  ...
                  Specific project Management functionality will be implemented based on
