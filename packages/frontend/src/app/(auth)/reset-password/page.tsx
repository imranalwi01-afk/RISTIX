...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${API_BASE_V1}/auth/reset-password`, {
        method: 'POST',
            ...
            <Fade in timeout={1000}>
              <Box>
                <Typography variant="h2" sx={{ fontWeight: 800, lineHeight: 1.1, mb: 3 }}>
                  ...
                  <span style={{ color: '#90CAF9' }}>Secure Your Account</span>
                </Typography>
                <Typography variant="h6" sx={{ opacity: 0.8, fontWeight: 400, lineHeight: 1.6, maxWidth: 500 }}>
                  Make sure it's at least 8 characters long, including a number and a symbol.
                </Typography>
              </Box>
            </Fade>
          </Box>
                ...
                {success ? (
                  ...
                  <Box component="form" onSubmit={handleSubmit} noValidate>
                    ...
                    <Button
                      ...
                      variant="contained"
                      size="large"
                      disabled={loading || !password || !confirmPassword || !token || !!error && error.includes('Invalid')}
