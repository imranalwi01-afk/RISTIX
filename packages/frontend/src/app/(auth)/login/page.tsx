...
export default function LoginPage() {
  ...
  const loginTheme = useMemo(() => createTheme({
    palette: {
      mode: 'light',
      primary: {
        main: isPlatformAdmin ? '#d32f2f' : '#1976d2', // Red for Admin, Blue for Regular
      },
      text: {
        primary: '#1A2027',
        secondary: '#6B7280',
                ...
                <Box component="form" onSubmit={handleLogin} noValidate>
                  ...
                  <Box sx={{ mb: 3 }}>
                    <FormControl fullWidth variant="outlined" size="small">
                      ...
                      <Select
                        ...
                        disabled={tenantsLoading || loginLoading || isPlatformAdmin} // 🔒 Disable for Admin
                        startAdornment={
                  ...
                  <Button
                    ...
                    sx={{
                      ...
                      fontSize: '1rem',
                      fontWeight: 600,
                      backgroundColor: isPlatformAdmin ? '#d32f2f' : undefined, // Red button for admin
                      boxShadow: isPlatformAdmin ? '0 4px 12px rgba(211, 47, 47, 0.2)' : '0 4px 12px rgba(21, 101, 192, 0.2)',
                      '&:hover': {
                        backgroundColor: isPlatformAdmin ? '#b71c1c' : undefined,
