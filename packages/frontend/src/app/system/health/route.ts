...
export async function GET() {
  ...
  const candidates = [
    `http://127.0.0.1:3000/api/v1/health`, // Docker default
    `http://localhost:3000/api/v1/health`,
    `http://127.0.0.1:3001/api/v1/health`, // Local default
    ...
    `http://127.0.0.1:${backendPort}/api/v1/health`, // Keep original as backup
