...
export default function ProfileSettingsPage() {
  ...
  const getApiBase = (): string => {
    try {
      ...
      console.log('✅ Profile Page: Using centralized API base URL:', config.api.base);
                ...
                <Box sx={{ textAlign: 'center', mb: 3 }}>
                  ...
                  >
                    <Avatar
                      ...
                      sx={{
                        ...
                        mb: 2,
                        border: '3px solid',
                        borderColor: bankingMode === 'syariah' ? 'success.main' : 'primary.main'
                      }}
                    >
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'center', gap: 1, mb: 2 }}>
                    <Chip
                      ...
                      color={profile.bankingAccess === 'SYARIAH' ? 'success' : 'primary'}
                      size="small"
                      icon={profile.syariahCertified ? <SecurityIcon /> : <BusinessIcon />}
                    />
                    {profile.syariahCertified && (
                      <Chip
