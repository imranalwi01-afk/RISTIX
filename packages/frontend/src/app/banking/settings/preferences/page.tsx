...
const defaultPreferences: UserPreferences = {
  ...
  syariahBoardNotifications: false,
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid size={{ xs: 12, sm: 6 }}>
                    <FormControlLabel
                      control={
                        <Switch
                          checked={preferences.syariahBoardNotifications}
                          onChange={(e) => handlePreferenceChange('syariahBoardNotifications', e.target.checked)}
                        />
                      }
                      label="Syariah Board Notifications"
                    />
                  </Grid>
                </Grid>
              </CardContent>
