...
// Features: Light/Dark themes, conventional banking themes, custom colors
...
export default function ThemeSettingsPage() {
  ...
  const [themeSettings, setThemeSettings] = useState<ThemeSettings>({
    mode: 'light',
    bankingTheme: bankingMode as 'conventional' | 'dual',
  ...
  const handleBankingThemeChange = (bankingTheme: 'conventional' | 'dual') => {
