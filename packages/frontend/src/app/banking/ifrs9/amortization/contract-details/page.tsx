...
export default function ContractDetailsPage() {
    ...
    const loadData = async () => {
        try {
            ...
            const response = await apiCall(`/api/v1/banking/ifrs9/amortization-module/contract-details?${params}`) as ApiResponse<ContractDetail>;
        ...
        <Container maxWidth="xl" sx={{ py: 3 }}>
            <Box mb={3}>
                ...
                <Typography variant="body1" color="text.secondary">
                    Account and contract information from the amortization system.
                </Typography>
            </Box>
