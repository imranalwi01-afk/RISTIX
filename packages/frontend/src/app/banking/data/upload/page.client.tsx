...
export default function DataUploadPage() {
  ...
  const canViewDataUpload = hasAnyPermission(['banking.data.upload.view']);
  const canUploadData = hasAnyPermission(['banking.data.upload.create']);
  const canValidateData = hasAnyPermission(['banking.data.validation.run']);
  const canProcessData = hasAnyPermission(['banking.data.upload.process']);
