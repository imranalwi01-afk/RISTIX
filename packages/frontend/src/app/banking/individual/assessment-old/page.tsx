...
const WatchlistSection = dynamic(() => import('../watchlist-old/page'));
...
export default function IndividualAssessmentOldPage() {
  ...
  return (
    <Container maxWidth="xl" sx={{ py: 2 }}>
      <FullstackIndicator />
      <PageHeader
        title="Assessment Workspace (Old)"
        subtitle="Legacy individual impairment workspace from commit 2301badfc5ea65510b50f0438f532e45a5ab486b."
      />

      <Alert severity="info" sx={{ mb: 2 }}>
        This is the old workspace variant for comparison.
      </Alert>
