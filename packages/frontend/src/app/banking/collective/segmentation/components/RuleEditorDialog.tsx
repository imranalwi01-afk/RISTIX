        ...
        <Grid container spacing={2}>
          ...
          <Grid size={{ xs: 12 }}>
            <FormControl fullWidth>
              ...
              >
                {tables.map((t, idx) => (
                  <MenuItem key={`${t.id}-${idx}`} value={t.value}>{t.label}</MenuItem>
                ))}
              </Select>
            </FormControl>
          </Grid>
          ...
          <Grid size={{ xs: 12 }}>
            <FormControl fullWidth disabled={!formData.table_name}>
              ...
              >
                {columns.map((c, idx) => (
                  <MenuItem key={`${c.id}-${idx}`} value={c.value}>{c.label}</MenuItem>
                ))}
              </Select>
            </FormControl>
          </Grid>
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <FormControl fullWidth>
              ...
              >
                {operators.map((o, idx) => (
                  <MenuItem key={`${o.id}-${idx}`} value={o.value}>{o.label}</MenuItem>
                ))}
              </Select>
            </FormControl>
          </Grid>
