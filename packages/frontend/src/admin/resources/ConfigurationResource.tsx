...
// ============================================================================
// File Path: packages/frontend/src/admin/resources/ConfigurationResource.tsx
 ...
 */
const ConfigCategoryChip: React.FC = () => {
 ...
 */
const ConfigValueDisplay: React.FC = () => {
  const record = useRecordContext<Configuration>();
