...
// ============================================================================
// File Path: packages/frontend/src/admin/resources/portfolios/PortfolioResource.tsx
 ...
 */
const PortfolioStatusChip: React.FC<any> = () => {
 ...
 */
const BankingTypeChip: React.FC<any> = () => {
  const record = useRecordContext<Portfolio>();
