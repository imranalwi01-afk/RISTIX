        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              "connect-src 'self' wss: ws: http://localhost:* http://127.0.0.1:* http://172.25.0.25:* https://*.ifrspro.id https://*.danafin.com https://*.danafin.id",
              "frame-ancestors 'self'",
              "frame-src 'self' http://localhost:* http://172.25.0.25:* https://*.ifrspro.id https://*.danafin.com https://*.danafin.id",
            ].join('; '),
          },
        ],
      },
