...
- `YieldableError`\<`this`\> & `object` & `Readonly`\<\{ `field?`: `string`; `message`: `string`; `resource`: `string`; `value?`: `unknown`; \}\>

## Constructors

### Constructor

> **new ConflictError**(`args`): `ConflictError`
...
`Data.TaggedError('ConflictError')<{ readonly message: string readonly resource: string readonly field?: string readonly value?: unknown }>.constructor`
...
> `readonly` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `ConflictError`, `unknown`, `never`, `unknown`, `never`\>
...
> `readonly` **\[EffectTypeId\]**: `VarianceStruct`\<`never`, `ConflictError`, `never`\>
...
> `readonly` **\[SinkTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `ConflictError`, `never`\>
...
> `readonly` **\[StreamTypeId\]**: `VarianceStruct`\<`never`, `ConflictError`, `never`\>
...
> **\[iterator\]**(): `EffectGenerator`\<`Effect`\<`never`, `ConflictError`, `never`\>\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:286

#### Returns

`EffectGenerator`\<`Effect`\<`never`, `ConflictError`, `never`\>\>
