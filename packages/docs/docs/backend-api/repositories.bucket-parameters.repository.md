...
Defined in: [src/repositories/bucket-parameters.repository.ts:10](https://github.com/ifrspro/ifrs9-iaf/blob/bb1ac57ad2b5d07ecfce33a99f28955a8c25940f/packages/new-backend/src/repositories/bucket-parameters.repository.ts#L10)
...
> **findHeaders**: (`search?`, `basis?`, `columnFilters?`) => `Effect`&lt;`object`[], [`DatabaseError`](lib.errors.md#databaseerror), `never`&gt;
