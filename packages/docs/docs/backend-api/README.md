...
See [`docs/architecture/adr/`](_media/README.md) for documented decisions:

- [ADR-0001: Backend Technology Stack](_media/0001-backend-technology-stack.md)
- [ADR-0002: Effect-ts for Error Handling](_media/0002-effect-ts-error-handling.md)
- [ADR-0003: Drizzle ORM](_media/0003-drizzle-orm.md)
