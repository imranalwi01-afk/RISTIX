...
Defined in: [packages/new-backend/src/services/parameters.service.ts:10](https://github.com/ifrspro/ifrs9-iaf/blob/2c233b31171a451bb86daacd4389a961f1213deb/packages/new-backend/src/services/parameters.service.ts#L10)
...
> **createAppSetting**: (`data`, `userId`) => `Effect`\<\{ `banking_type`: `any`; `details`: `any`; `is_active`: `any`; `param_code`: `any`; `param_name`: `any`; `param_type`: `any`; `param_usage`: `any`; `pkid`: `number`; `requires_approval`: `any`; \}, [`DatabaseError`](../../../lib/errors/classes/DatabaseError.md), `never`\>
...
`Effect`\<\{ `banking_type`: `any`; `details`: `any`; `is_active`: `any`; `param_code`: `any`; `param_name`: `any`; `param_type`: `any`; `param_usage`: `any`; `pkid`: `number`; `requires_approval`: `any`; \}, [`DatabaseError`](../../../lib/errors/classes/DatabaseError.md), `never`\>

An Effect resolving to the created setting header

### createAppSettingDetail()

> **createAppSettingDetail**: (`data`, `userId`) => `Effect`\<\{ `id`: `number`; `is_active`: `boolean`; `param_code`: `string`; `param_desc`: `string`; `param_seq`: `number`; `value1`: `string`; `value2`: `string`; `value3`: `string`; \}, `unknown`, `unknown`\>
...
`Effect`\<\{ `id`: `number`; `is_active`: `boolean`; `param_code`: `string`; `param_desc`: `string`; `param_seq`: `number`; `value1`: `string`; `value2`: `string`; `value3`: `string`; \}, `unknown`, `unknown`\>
