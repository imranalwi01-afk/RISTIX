...
Defined in: [src/repositories/tenant.repository.ts:24](https://github.com/ifrspro/ifrs9-iaf/blob/5a4b2221d62f9d823811e12bfc71b7ff82ae62fa/packages/new-backend/src/repositories/tenant.repository.ts#L24)
...
`Partial`\<[`NewPlatformTenant`](../../../db/schema/platform.schema/type-aliases/NewPlatformTenant.md)\>
