...
Defined in: [src/repositories/parameters.repository.ts:10](https://github.com/ifrspro/ifrs9-iaf/blob/cf4905123c7eb3e9046f36ce3f92dd13536ac238/packages/new-backend/src/repositories/parameters.repository.ts#L10)
...
`Effect`\<\{ `createdby`: `string`; `createddate`: `string`; `createdhost`: `string`; `paramCode`: `string`; `paramdesc`: `string` \| `null`; `paramSeq`: `number`; `pkid`: `bigint`; `updatedby`: `string` \| `null`; `updateddate`: `string` \| `null`; `updatedhost`: `string` \| `null`; `value1`: `string`; `value2`: `string`; `value3`: `string`; \}, [`DatabaseError`](../../../lib/errors/classes/DatabaseError.md), `never`\>

An Effect resolving to the created detail

### createHeader()

> **createHeader**: (`data`) => `Effect`\<\{ `createdby`: `string`; `createddate`: `string`; `createdhost`: `string`; `paramCode`: `string` \| `null`; `paramName`: `string` \| `null`; `paramType`: `string` \| `null`; `paramUsage`: `string` \| `null`; `pkid`: `bigint`; `updatedby`: `string` \| `null`; `updateddate`: `string` \| `null`; `updatedhost`: `string` \| `null`; \}, [`DatabaseError`](../../../lib/errors/classes/DatabaseError.md), `never`\>
...
`Effect`\<\{ `createdby`: `string`; `createddate`: `string`; `createdhost`: `string`; `paramCode`: `string` \| `null`; `paramName`: `string` \| `null`; `paramType`: `string` \| `null`; `paramUsage`: `string` \| `null`; `pkid`: `bigint`; `updatedby`: `string` \| `null`; `updateddate`: `string` \| `null`; `updatedhost`: `string` \| `null`; \}, [`DatabaseError`](../../../lib/errors/classes/DatabaseError.md), `never`\>
...
> **deleteHeader**: (`code`) => `Effect`\<\{ `createdby`: `string`; `createddate`: `string`; `createdhost`: `string`; `paramCode`: `string` \| `null`; `paramName`: `string` \| `null`; `paramType`: `string` \| `null`; `paramUsage`: `string` \| `null`; `pkid`: `bigint`; `updatedby`: `string` \| `null`; `updateddate`: `string` \| `null`; `updatedhost`: `string` \| `null`; \}, [`DatabaseError`](../../../lib/errors/classes/DatabaseError.md), `never`\>
...
> **findHeaderByCode**: (`code`) => `Effect`\<\{ `createdby`: `string`; `createddate`: `string`; `createdhost`: `string`; `details`: `object`[]; `paramCode`: `string` \| `null`; `paramName`: `string` \| `null`; `paramType`: `string` \| `null`; `paramUsage`: `string` \| `null`; `pkid`: `bigint`; `updatedby`: `string` \| `null`; `updateddate`: `string` \| `null`; `updatedhost`: `string` \| `null`; \} \| `undefined`, [`DatabaseError`](../../../lib/errors/classes/DatabaseError.md), `never`\>
