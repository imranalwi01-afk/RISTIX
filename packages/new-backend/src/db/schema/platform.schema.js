...
exports.platformTenantsRelations = (0, drizzle_orm_1.relations)(exports.platformTenants, ({ many }) => ({
 ...
 */
exports.platformEmailTemplates = exports.platformSchema.table('email_templates', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    code: (0, pg_core_1.varchar)('code', { length: 100 }).notNull().unique(), // e.g. welcome_email, forgot_password
    ...
    availableVariables: (0, pg_core_1.jsonb)('available_variables').default([]).notNull(),
    createdAt: (0, pg_core_1.timestamp)('created_at', { withTimezone: true }).notNull().defaultNow(),
    updatedAt: (0, pg_core_1.timestamp)('updated_at', { withTimezone: true }).notNull().defaultNow(),
}, (table) => [
    (0, pg_core_1.uniqueIndex)('platform_email_templates_code_idx').on(table.code),
]);
// =============================================================================
