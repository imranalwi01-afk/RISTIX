...
exports.userActivityLogs = exports.auditSchema.table('user_activity_logs', {
    ...
    (0, pg_core_1.index)('user_activity_tenant_idx').on(table.tenantId),
...
exports.userActivityLogsRelations = (0, drizzle_orm_1.relations)(exports.userActivityLogs, function (_a) {
    var one = _a.one;
    return ({
        user: one(core_1.users, {
        ...
        tenant: one(platform_schema_1.tenants, {
            fields: [exports.userActivityLogs.tenantId],
            references: [platform_schema_1.tenants.id],
        }),
    });
});
