...
exports.roles = exports.coreSchema.table('roles', {
    ...
    maxImpactLevel: (0, pg_core_1.varchar)('max_impact_level', { length: 20 }).default('low'), // low, medium, high
...
exports.permissions = exports.coreSchema.table('permissions', {
    ...
    impactLevel: (0, pg_core_1.varchar)('impact_level', { length: 20 }).default('low'), // low, medium, high
...
exports.permissionApprovalPoliciesRelations = (0, drizzle_orm_1.relations)(exports.permissionApprovalPolicies, ({ one }) => ({
    tenant: one(core_1.tenants, {
