...
exports.workflowTransitions = exports.workflowSchema.table('workflow_transitions', {
    ...
    workflowId: (0, pg_core_1.uuid)('workflow_id')
        .notNull()
        .references(function () { return exports.workflows.id; }, { onDelete: 'cascade' }),
    tenantId: (0, pg_core_1.uuid)('tenant_id').notNull(),
    // Transition details
...
// RELATIONS
// =============================================================================
exports.workflowsRelations = (0, drizzle_orm_1.relations)(exports.workflows, function (_a) {
...
exports.workflowTransitionsRelations = (0, drizzle_orm_1.relations)(exports.workflowTransitions, function (_a) {
    var one = _a.one;
    return ({
...
exports.workflowJobsRelations = (0, drizzle_orm_1.relations)(exports.workflowJobs, function (_a) {
    var one = _a.one;
    return ({
        workflow: one(exports.workflows, {
