...
var platform_schema_1 = require("./platform.schema"); // ✅ Import tenants from platform schema
/**
...
exports.emailVerificationTokensRelations = (0, drizzle_orm_1.relations)(exports.emailVerificationTokens, function (_a) {
    var one = _a.one;
    return ({
        user: one(core_1.users, {
