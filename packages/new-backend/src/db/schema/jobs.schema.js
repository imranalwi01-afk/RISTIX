...
exports.jobDefinitions = core_1.coreSchema.table('job_definitions', {
    ...
    tenantId: (0, pg_core_1.uuid)('tenant_id').references(function () { return platform_schema_1.tenants.id; }).notNull(),
...
exports.jobExecutions = core_1.coreSchema.table('job_executions', {
    ...
    jobDefinitionId: (0, pg_core_1.uuid)('job_definition_id').references(function () { return exports.jobDefinitions.id; }),
    tenantId: (0, pg_core_1.uuid)('tenant_id').references(function () { return platform_schema_1.tenants.id; }).notNull(),
