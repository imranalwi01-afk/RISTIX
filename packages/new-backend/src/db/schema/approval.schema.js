...
exports.approvalMatrices = exports.approvalSchema.table('approval_matrices', {
    ...
    tenantId: (0, pg_core_1.uuid)('tenant_id').references(function () { return platform_schema_1.tenants.id; }),
...
exports.approvalLevels = exports.approvalSchema.table('approval_levels', {
    ...
    matrixId: (0, pg_core_1.uuid)('matrix_id')
        .notNull()
        .references(function () { return exports.approvalMatrices.id; }, { onDelete: 'cascade' }),
...
exports.approvalRequests = exports.approvalSchema.table('approval_requests', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    matrixId: (0, pg_core_1.uuid)('matrix_id').references(function () { return exports.approvalMatrices.id; }),
    tenantId: (0, pg_core_1.uuid)('tenant_id')
        .notNull()
        .references(function () { return platform_schema_1.tenants.id; }),
    ...
    requestedBy: (0, pg_core_1.uuid)('requested_by')
        .notNull()
        .references(function () { return core_1.users.id; }),
    ...
    completedBy: (0, pg_core_1.uuid)('completed_by').references(function () { return core_1.users.id; }),
}, function (table) { return [
...
exports.approvalActions = exports.approvalSchema.table('approval_actions', {
    ...
    requestId: (0, pg_core_1.uuid)('request_id')
        .notNull()
        .references(function () { return exports.approvalRequests.id; }, { onDelete: 'cascade' }),
    ...
    delegatedTo: (0, pg_core_1.uuid)('delegated_to').references(function () { return core_1.users.id; }),
...
exports.notifications = exports.approvalSchema.table('notifications', {
    ...
    tenantId: (0, pg_core_1.uuid)('tenant_id')
        .notNull()
        .references(function () { return platform_schema_1.tenants.id; }),
    approvalRequestId: (0, pg_core_1.uuid)('approval_request_id').references(function () { return exports.approvalRequests.id; }, { onDelete: 'set null' }),
    ...
    triggeredBy: (0, pg_core_1.uuid)('triggered_by').references(function () { return core_1.users.id; }, { onDelete: 'set null' }),
...
exports.notificationDeliveries = exports.approvalSchema.table('notification_deliveries', {
    ...
    notificationId: (0, pg_core_1.uuid)('notification_id')
        .notNull()
        .references(function () { return exports.notifications.id; }, { onDelete: 'cascade' }),
    tenantId: (0, pg_core_1.uuid)('tenant_id')
        .notNull()
        .references(function () { return platform_schema_1.tenants.id; }),
    recipientUserId: (0, pg_core_1.uuid)('recipient_user_id').references(function () { return core_1.users.id; }, { onDelete: 'cascade' }),
...
exports.notificationPreferences = exports.approvalSchema.table('notification_preferences', {
    ...
    userId: (0, pg_core_1.uuid)('user_id')
        .notNull()
        .references(function () { return core_1.users.id; }, { onDelete: 'cascade' }),
...
// RELATIONS
// =============================================================================
exports.approvalMatricesRelations = (0, drizzle_orm_1.relations)(exports.approvalMatrices, function (_a) {
...
exports.approvalLevelsRelations = (0, drizzle_orm_1.relations)(exports.approvalLevels, function (_a) {
    var one = _a.one;
    return ({
...
exports.approvalRequestsRelations = (0, drizzle_orm_1.relations)(exports.approvalRequests, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
        tenant: one(platform_schema_1.tenants, {
...
exports.approvalActionsRelations = (0, drizzle_orm_1.relations)(exports.approvalActions, function (_a) {
    var one = _a.one;
    return ({
...
exports.notificationDeliveriesRelations = (0, drizzle_orm_1.relations)(exports.notificationDeliveries, function (_a) {
    var one = _a.one;
    return ({
