...
INSERT INTO menu.menu_items (id, tenant_id, category_id, name, path, icon, sort_order, level, is_active, is_visible, requires_auth, banking_type, created_by) VALUES
    ...
    ('b1000000-0004-4000-8000-000000000005', 'f7b3a087-8a42-40c4-baca-9dc92cc0a2be', 'a0000000-1000-4000-8000-000000000004', 'FL Scalar', '/banking/collective/fl-scalar', 'Functions', 5, 0, true, true, true, 'both', '550e8400-1111-2222-3333-444455555201'),
    ...
    ('b1000000-0005-4000-8000-000000000002', 'f7b3a087-8a42-40c4-baca-9dc92cc0a2be', 'a0000000-1000-4000-8000-000000000005', 'Individual Provision', '/banking/individual/provision', 'Savings', 2, 0, true, true, true, 'both', '550e8400-1111-2222-3333-444455555201'),
    ...
    ('b1000000-0006-4000-8000-000000000005', 'f7b3a087-8a42-40c4-baca-9dc92cc0a2be', 'a0000000-1000-4000-8000-000000000006', 'Data Upload', '/banking/data/upload', 'UploadFile', 5, 0, true, true, true, 'both', '550e8400-1111-2222-3333-444455555201'),
    ('b1000000-0006-4000-8000-000000000006', 'f7b3a087-8a42-40c4-baca-9dc92cc0a2be', 'a0000000-1000-4000-8000-000000000006', 'Data Validation', '/banking/data/validation', 'VerifiedUser', 6, 0, true, true, true, 'both', '550e8400-1111-2222-3333-444455555201'),
    ...
    ('b1000000-0007-4000-8000-000000000005', 'f7b3a087-8a42-40c4-baca-9dc92cc0a2be', 'a0000000-1000-4000-8000-000000000007', 'EAD Model', '/banking/ifrs9-reports/ead-model', 'Functions', 5, 0, true, true, true, 'both', '550e8400-1111-2222-3333-444455555201'),
    ...
    ('b1000000-0010-4000-8000-000000000003', 'f7b3a087-8a42-40c4-baca-9dc92cc0a2be', 'a0000000-1000-4000-8000-000000000010', 'ETL Tools', '/banking/tools/etl', 'Transform', 3, 0, true, true, true, 'both', '550e8400-1111-2222-3333-444455555201'),
    ...
    ('b1000000-0011-4000-8000-000000000004', 'f7b3a087-8a42-40c4-baca-9dc92cc0a2be', 'a0000000-1000-4000-8000-000000000011', 'Menu Management', '/banking/maintenance/menus', 'Menu', 4, 0, true, true, true, 'both', '550e8400-1111-2222-3333-444455555201'),
