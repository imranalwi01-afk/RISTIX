-- Migration: Seed initial permission approval policies
-- Purpose: Set approval requirements for ADMIN and REPORTING category permissions
-- Related: docs/rbac/approval-plan.md

-- Seed policies for all active tenants and permissions
-- ADMIN permissions require Level 2 approval (2 approvers)
