...
const envSchema = z.object({
    ...
    // CORS Configuration
    CORS_ORIGINS: z.string().default('http://localhost:4231,http://127.0.0.1:4231,http://[::1]:4231,http://host.docker.internal:4231,http://local.ristix.bdo-ki.com:4231,https://iaf-ifrs.ifrspro.id,https://iaf-ifrs-be.ifrspro.id,https://ristix.bdo-ki.com,https://ristix.bdo-ki.com'),
