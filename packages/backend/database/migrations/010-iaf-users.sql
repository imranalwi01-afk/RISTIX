...
('550e8400-1111-2222-3333-444455555201', 'admin@iaf.co.id', 'admin_iaf', 'IAF Tenant Super Administrator', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj/RK.s5uO.GG', true, 'iaf'),
('550e8400-1111-2222-3333-444455555202', 'ifrs.manager@iaf.co.id', 'ifrs_manager_iaf', 'IAF IFRS 9 Manager', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj/RK.s5uO.GG', true, 'iaf'),
('550e8400-1111-2222-3333-444455555203', 'cro@iaf.co.id', 'cro_iaf', 'IAF Chief Risk Officer', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj/RK.s5uO.GG', true, 'iaf'),
('550e8400-1111-2222-3333-444455555204', 'risk.analyst@iaf.co.id', 'risk_analyst_iaf', 'IAF Risk Analyst', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj/RK.s5uO.GG', true, 'iaf')
...
-- Show users created
SELECT 'Users Created' as status, COUNT(*) as count FROM core.users WHERE tenant_id = 'iaf';
