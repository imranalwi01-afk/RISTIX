...
run_shiny() {
  (
    ...
    stdbuf -oL -eL Rscript -e "shiny::runApp('/opt/r-analytics/shiny-app/app36.R', host='0.0.0.0', port=as.integer(Sys.getenv('R_PORT','4236')), launch.browser=FALSE)"
...
monitor_endpoint "shiny" "http://127.0.0.1:${DASHBOARD_PORT}/" "shiny::runApp('/opt/r-analytics/shiny-app/app36.R'" &
SHINY_MONITOR_PID=$!
