...
// Usage: Import and use this config for local development

import { EnvironmentConfig } from './centralized-config';

export const LOCAL_ENV_CONFIG: EnvironmentConfig = {
...
export const setupLocalEnvironment = () => {
  console.log('🌐 Setting up Local Development Environment');
  console.log(`📍 Frontend: ${LOCAL_ENV_CONFIG.frontend.url}`);
  console.log(`📍 Backend API: ${LOCAL_ENV_CONFIG.backend.apiUrl}`);
  console.log(`📍 R Analytics: ${LOCAL_ENV_CONFIG.rAnalytics.dashboardUrl}`);
  console.log(`📍 Database: ${LOCAL_ENV_CONFIG.database.host}:${LOCAL_ENV_CONFIG.database.port}`);
